...
def generate_launch_description():
    ...
    robot_name_in_model = 'recolector'

    # Get URDF via xacro

    urdf_file_name = 'recolector_v8.urdf'
    urdf = os.path.join(
        get_package_share_directory('recolector_ros2'),
        'urdf',
        urdf_file_name
        )
    ...
    gazebo = ExecuteProcess(
        cmd=['gazebo',"/home/ubuntu/worlds/map_v3.world", '--verbose', '-s', 'libgazebo_ros_factory.so', 
